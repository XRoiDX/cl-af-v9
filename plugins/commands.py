...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢', url='https://t.me/musicgramam')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('🌹 ᴍy ᴍᴜꜱɪᴄ ɢʀᴏᴜᴩ 🌹', url=f'https://t.me/musicgramam')
            ],[
            InlineKeyboardButton('ɢʀᴏᴜᴩ', url='https://t.me/musicgramam'), 
            InlineKeyboardButton('ᴜᴩᴅᴀᴛᴇꜱ', url='https://t.me/musicgramam')
            ],[      
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**𝑱𝒐𝒊𝒏 𝑶𝒖𝒓 𝑴𝒖𝒔𝒊𝒄 𝑼𝒑𝒅𝒂𝒕𝒆𝒔 𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑻𝒐 𝑼𝒔𝒆 𝑻𝒉𝒊𝒔 𝑩𝒐𝒕!**",
